 ...
 */
package ddf.catalog.migrate.migration.targetlist;
...
public class TargetListMigrationTest {
  ...
  private TargetListMigration targetListMigration;
  ...
  public void setup() throws Exception {
    targetListMigration =
        new TargetListMigration(catalogFramework, filterBuilder, xmlInputTransformer, security);
  ...
  private Metacard getWorkspaceMetacard(String id) throws IOException {
    ...
    InputStream resourceStream =
        TargetListMigrationTest.class.getResourceAsStream("/query.xml");
