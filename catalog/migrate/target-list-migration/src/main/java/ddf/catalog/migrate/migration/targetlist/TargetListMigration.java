...
public class TargetListMigration implements DataMigratable {

  private static final Logger LOGGER = LoggerFactory.getLogger(TargetListMigration.class);
